        ...
        <div class="col-lg-9 col-md-9 col-sm-8 col-md-push-3">
          <div class="aa-product-catg-content">
            ...
            <div class="aa-product-catg-body">
              ...
              $sql1=mysqli_query($conn,"select * from item_master  where sub_cat_id = '".$sub_cat."'");
            ...
            $page_first_result = ($page-1) * $results_per_page;  
                ...
                $sql=mysqli_query($conn,"select * from item_master where sub_cat_id = '".$sub_cat."'LIMIT " . $page_first_result . ',' . $results_per_page);
                ...
                <li>
                  ...
                  <?php 
                    ...
                    <a class="aa-add-card-btn" href="?addtobag=<?= $sql_row[0]?>&sub=<?= $sub_cat?>"><span class="fa fa-shopping-cart"></span>Add To Bag</a>
                   <?php }?>
                    <figcaption>
                  ...
                  <div class="aa-product-hvr-content">
                    <a href="?wishlist=<?php echo $sql_row[0]; ?>&sub=<?= $sub_cat?>" data-toggle="tooltip" data-placement="top" title="Add to Wishlist"><span class="fa fa-heart-o"></span></a>
                ...
                <?php 
                        if(isset($_GET['wishlist'])){
                          ...
                          if(mysqli_num_rows($select_wish) > 0 ){
                            echo "<script>window.location.href ='sub_category.php?id=".$_GET['sub']." ' </script>";
              ...
              <nav>
                <ul class="pagination">
                    ...
                    <?php if($page > 1){
                      ...
                      ?>
                       <li>
                    <a href="sub_category.php?page=<?php echo $page - 1 ?>&id=<?php echo $sub_cat ?>" aria-label="Previous">
               ...
               ?>
                  <li><a  href="sub_category.php?page=<?php echo $page ?>&id=<?php echo $sub_cat ?>"><?php echo $page ?></a></li>
                ...
                ?>
                  ...
                  if($ppp < $number_of_page){  ?>
                   <li >
                    <a href="sub_category.php?page=<?php echo $ppp +1 ?>&id=<?php echo $sub_cat ?>" aria-label="Next">
                          ...
                          <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js" integrity="sha512-AA1Bzp5Q0K1KanKKmvN/4d3IRKVlv9PYgwFPvm32nPO6QS8yH1HO7LbgB1pgiOxPtfeg5zEn2ba64MUcqJx6CA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
                                        <script>
                                          ...
                                          button: "oh no!",  
                                            ...
                                            setTimeout(function(){
                                                window.location.href = 'sub_category.php?id=<?php echo $_GET['sub']; ?>';
                                                }, 1200);
