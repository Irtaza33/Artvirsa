          ...
          <div class="aa-product-catg-content">
            ...
            <div class="aa-product-catg-body">
              ...
              $results_per_page =6;  
                ...
                $sql1=mysqli_query($conn,"select * from item_master");
              ...
              $sql = mysqli_query($conn,"SELECT * FROM item_master LIMIT " . $page_first_result . ',' . $results_per_page);  
                ...
                <li>
                  ...
                  <?php 
                    ...
                    <a class="aa-add-card-btn" href="?addtobag=<?= $sql_row[0]?>"><span class="fa fa-shopping-cart"></span>Add To Bag</a>
                    <?php }?>
                    <figcaption>
                  ...
                  <div class="aa-product-hvr-content">
                    <a href="?wishlist=<?php echo $sql_row[0]; ?>" data-toggle="tooltip" data-placement="top" title="Add to Wishlist"><span class="fa fa-heart-o"></span></a>
            ...
            <div class="aa-product-catg-pagination">
              <nav>
               ...
               ?>
                  <li><a  href="products.php?page=<?php echo $page ?>"><?php echo $page ?></a></li>
                ...
                ?>
                  ...
                  if($ppp < $number_of_page){  ?>
                   <li >
                    <a href="products.php?page=<?php echo $ppp +1 ?>" aria-label="Next">
